 ...
 * generated by Xtext
 */
package org.poc.idm.xtext.wdl.formatting;
...
public class WdlFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private WdlGrammarAccess _wdlGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._wdlGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._wdlGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._wdlGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._wdlGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._wdlGrammarAccess.getML_COMMENTRule();
